    ...
    >
        <div className="relative" ref={pickerRef}>
          ...
          >
            ...
            {yearStr && (
              <span className="text-sm sm:text-base lg:text-xl font-normal text-slate-300 dark:text-white/50 tracking-tight" style={{ fontFamily: "'Archivo Variable', 'Archivo', sans-serif", fontWeight: 400 }}>
                {yearStr}
              </span>
            )}
            <ChevronDown
