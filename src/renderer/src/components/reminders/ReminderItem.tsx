...
export default function ReminderItem({ reminder, date, onToggle, onEdit, onDelete }: Props) {
  ...
  return (
    <div
      className={`flex items-start gap-3 px-4 py-3.5 group rounded-xl border border-slate-200/80 dark:border-white/[0.08] border-b-[2.5px] border-b-slate-300/80 dark:border-b-white/[0.15] bg-white dark:bg-white/[0.03] transition-all grain-surface ${
