...
const SearchBar = forwardRef<HTMLInputElement>(function SearchBar(_props, ref) {
  ...
  return (
    <div className="relative w-full max-w-sm">
      ...
      {open && (
        <div className="absolute top-full mt-1 left-0 right-0 z-50 bg-white dark:bg-[#0e1420]/90 dark:backdrop-blur-xl rounded-xl shadow-xl shadow-black/20 dark:shadow-black/50 border border-gray-200 dark:border-white/[0.1] overflow-hidden">
